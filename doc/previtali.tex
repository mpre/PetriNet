...
\begin{figure}[htbp] 
\centering% 
\subfigure[\label{es:philo1}] 
{\includegraphics[width=5cm]{img/philo1.png}}\hspace{1cm}\vspace{1cm}% 
\subfigure[\label{es:philo2}] 
{\includegraphics[width=5cm]{img/philo2.png}}\hspace{1cm}\vspace{1cm}% 
\subfigure[\label{es:philo3}] 
{\includegraphics[width=5cm]{img/philo3.png}}\hspace{2cm}% 
...
\begin{figure}[htbp] 
\centering% 
\subfigure[\label{es:fork1}] 
{\includegraphics[width=5cm]{img/fork1.png}}\hspace{1cm}\vspace{1cm}% 
\subfigure[\label{es:fork2}] 
{\includegraphics[width=5cm]{img/fork2.png}}\hspace{1cm}\vspace{1cm}% 
%\subfigure[\label{l12}] 
%{\includegraphics[width=6cm]{layout/lay12}}\hspace{2cm}% 
