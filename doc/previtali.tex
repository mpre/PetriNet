...
% L'obbiettivo di questo stage è portare avanti lo sviluppo di un
% linguaggio di specifica testuale per la definizione delle reti di
% Petri utilizzabile anche da utenti senza nozioni di programmazione. \\
% Le reti di Petri sono uno dei metodi di rappresentazione matematica di
% sistemi distribuiti inventate dal matematico tedesco Carl Adam Petri
% nel 1962. Queste reti hanno tre diversi elementi grafici utili alla
% loro definizione: i posti, le transizioni e gli archi.\\
...
% posti come condizioni di un sistema e, in presenza di marche, pensare
...
% compiute dal sistema. Le transizioni agiscono su gruppi di posti e
...
% Una delle prime modifche apportate al linguaggio è stata quella di
% passare dal trattare reti elementari (formate ciò da posti contenenti
% al più una marca e archi con peso uno) alle reti posti e transizioni
...
% dimensione è molto laborioso e con ogni porbabilità viene impiegato
% parecchio tempo nella creazione della struttura.\\
...
\section{Linguaggio PetriNet}\label{sec:linguaggio_petrinet}
Nella seguente sezione viene analizzato il linguaggio PetriNet come sviluppato durante il lavoro di tesi di Sara Faggioni.
